...
export const collectorService = {
    ...
    approvePendingCollector: async (email) => {
        const token = localStorage.getItem('token');
    ...
    rejectPendingCollector: async (email) => {
        const token = localStorage.getItem('token');
...
export const eventService = {
    ...
    createEvent: async (eventName, eventDate, eventTime) => {
        const token = localStorage.getItem('token');
    ...
    setDateAvailability: async (date, status) => {
        const token = localStorage.getItem('token');
